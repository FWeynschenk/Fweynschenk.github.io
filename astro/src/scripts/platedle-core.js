...
export const REGIONS = [
  { id: "nl", name: "Netherlands", flag: "🇳🇱", weight: 5, euband: "NL", bg: "linear-gradient(180deg,#fdc500,#f4af00)", fg: "#111",
...
// worth ~150 EP, a 1-in-a-million badge ~400,000.
export function badgeEP(badge) {
  const prob = Math.max(PROBS[badge.id] ?? 2e-7, 2e-7);
  return Math.max(50, Math.round((100 * Math.pow(1 / prob, 0.6)) / 5) * 5);
}
